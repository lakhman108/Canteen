...
class Orders(models.Model):
    ...
    payment_status = models.CharField(max_length=255, choices=[('Pending', 'Pending'), ('Paid', 'Paid')],
                                      default='Pending')
...
class FoodDetails(models.Model):
    ...
    rating=models.IntegerField(default=0,blank=True,null=True,max_length=1)
...
class Payment(models.Model):
    ...
    # def __str__(self):
    #     return self.order.id + ' - ' + self.created_at